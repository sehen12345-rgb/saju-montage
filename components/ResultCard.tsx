  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        <a
          href={imageUrl}
          download="배우자_초상화.svg"
          target="_blank"
          rel="noreferrer"
          className={`py-3 rounded-xl border-2 border-amber-400 text-amber-700 font-semibold text-sm text-center transition-all ${!imgLoaded ? "opacity-40 pointer-events-none" : "hover:bg-amber-50"}`}
        >
          💾 이미지 저장
        </a>
        <button
